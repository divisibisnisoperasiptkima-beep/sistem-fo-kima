/**
 * Column definitions for Monitoring Kontrak Aktif page
 */
...
export const monitoringColumns = [
  { label: "No", sticky: { left: "0px", width: "50px" }, render: (_row, idx, page = 1, pageSize = 20) => (page - 1) * pageSize + (idx ?? 0) + 1 },
  {
    ...
    render: (row) => (
      <span className="font-bold text-white block truncate max-w-[170px]" title={row.nama_pelanggan}>
...
export default monitoringColumns;
